...
public class Flight extends SelTestCase{
    @Given("^: I am at the flight home page$")
    public void i_am_at_the_home_page() throws Throwable {
        ...
        selTestCase.getWebDriver().get("https://phptravels.com/flights-module-features/");
    }
    ...
    @Then("^: I should be at the flight \"([^\"]*)\" page$")
